...
\]
  ...
  \subsection{Primitive Types}
    ...
    \begin{itemize}
      ...
      \item \textbf{timestamp}: represents an instant on the UTC time-line,
...
\label{sec:rpc-protocol}
  ...
  \label{sec:frame-format}
    ...
    \subsubsection{RESPONSE Frame}
      ...
      The payload of an \texttt{RESPONSE} frame MUST be an \emph{unary output
      ...
      outputs, the unary output tuple is encoded as the amount of items in the
