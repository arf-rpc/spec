...
v1beta1.mypackage.OtherName
  ...
  \subsection{Types}
    ...
    Additionally, map keys are restricted to primitive types, Structures and Enums. Other types are forbidden.
  ...
  \subsubsection{Methods}
    ...
    Unary inputs and outputs, and streams MUST use either structures or enums instead
    of primitive or composite types. This limitation was deliberately created to ensure
    all data transmitted through RPC methods are part of structures, enforcing all
    messages to be explicitly defined.
...
\label{sec:serialization}
  ...
  \subsection{Primitive Types}
    ...
    \begin{itemize}
      ...
      \item \textbf{timestamp}: encoded as an unsigned 64-bit integer
        (\texttt{uint64}) representing the number of milliseconds elapsed since
        the UTC Unix Epoch. Implementations that cannot represent millisecond
